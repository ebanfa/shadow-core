...
class WritingStyleCPT {
    ...
    public static $post_name = 'sb_wstyle'; 
 ...
 public static $related_child_entities = array(
  ...
  ------------------------------------------------------------------------------*/
    ...
    public static function sb_wstyle_table_head($defaults){
    ...
    public static function sb_wstyle_table_content($column_name, $post_id){
