...
class UrgencyCPT {
    ...
    public static $post_name = 'sb_docurgency'; 
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_docurgency', 
            array(
                'label' => 'Urgency',
                'labels' => array(
                'add_new'           => 'Add New',
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_docurgency') 
        {
    ...
    public static function sb_docurgency_table_head($defaults){
    ...
    public static function sb_docurgency_table_content($column_name, $post_id){
