...
class DocumentTypeCPT {
    ...
    public static $post_name = 'sb_doctype'; 
 ...
 public static $related_child_entities = array(
  ...
  ------------------------------------------------------------------------------*/
    ...
    public static function sb_doctype_table_head($defaults){
    ...
    public static function sb_doctype_table_content($column_name, $post_id){
