...
class ContentOrderCPT {
    ...
    public static $post_name = 'sb_corder'; 
    ...
    public static $custom_fields =  array(
        ...
        array('name' => 'numpages',
            'title' => 'No Of Pages',
            'description' => 'The No Of Pages field',
            'type' => 'text',
        ),
 ...
 public static $related_child_entities = array(
  ...
  ------------------------------------------------------------------------------*/
    ...
    public static function sb_corder_table_head($defaults){
        $defaults['entity_code']  = 'Code';
        $defaults['name']  = 'name';
        $defaults['email']  = 'name';
        $defaults['document_type']  = 'Document Type';
        $defaults['urgency']  = 'Urgency';
        $defaults['numpages']  = 'No Of Pages';
        $defaults['subject_area']  = 'Subject Area';
        $defaults['academic_level']  = 'Academic Level';
        $defaults['writing_style']  = 'Writing Style';
    ...
    public static function sb_corder_table_content($column_name, $post_id){
