...
class SubjectAreaCPT {
    ...
    public static $post_name = 'sb_subarea'; 
 ...
 public static $related_child_entities = array(
  ...
  ------------------------------------------------------------------------------*/
    ...
    public static function sb_subarea_table_head($defaults){
    ...
    public static function sb_subarea_table_content($column_name, $post_id){
