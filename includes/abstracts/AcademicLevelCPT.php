...
class AcademicLevelCPT {
    ...
    public static $post_name = 'sb_alevel'; 
 ...
 public static $related_child_entities = array(
  ...
  ------------------------------------------------------------------------------*/
    ...
    public static function sb_alevel_table_head($defaults){
    ...
    public static function sb_alevel_table_content($column_name, $post_id){
