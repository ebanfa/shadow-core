    ...
    public static function register_custom_post_type()
    {
       register_post_type('sb_noofpages', 
            array(
                ...
                'labels' => array(
                'add_new'           => 'Add New',
                'add_new_item'      => 'Add New Number Of Pages',
                'edit_item'         => 'Edit Number Of Pages',
                'new_item'          => 'New Number Of Pages',
                'view_item'         => 'View Number Of Pages',
                'search_items'      => 'Search Number Of Pages',
                'not_found'         => 'No Number Of Pages Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Number Of Pages',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
